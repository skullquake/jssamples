...
function Element(doc, localName, namespaceURI, prefix) {
	...
	this.getBBox=function(){
		return {
			x:typeof(this.x)=="undefined"?0:this.x,
			y:typeof(this.y)=="undefined"?0:this.y,
			width:typeof(this.width)=="undefined"?10:this.width,
			height:typeof(this.height)=="undefined"?10:this.height
		};
	}.bind(this);//skullquake - dagre
	*/
